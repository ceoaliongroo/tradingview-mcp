...
78 tools seems excessive, but with clear MCP server instructions and an `AGENTS.md` decision tree, the agent consistently selects the right tools. The key is descriptive tool names and the instruction block — not reducing tool count.
