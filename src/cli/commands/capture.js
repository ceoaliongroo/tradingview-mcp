  ...
  subcommands: new Map([
    ...
    ['demark-focus', {
      ...
      options: {
        ...
        barsBefore: { type: 'string', short: 'b', description: 'Bars to show before the focus bar (default 2)' },
        barsAfter: { type: 'string', short: 'a', description: 'Bars to show after the focus bar (default 2)' },
